...
endpointsFunction.registerUser = async (req, res) => {
  const {
    nome,
    morada,
    nif,
...
endpointsFunction.loginUser = async (req, res) => {
...
endpointsFunction.refreshTokenUser = async (req, res) => {
...
endpointsFunction.logoutUser = async (req, res) => {
  try {
    res.status(200).json({
      success: true,
